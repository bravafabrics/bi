...
delete_zone($_POST['service_zone_delete'], $_POST['country_zone_delete']); 
?>		
	<br /><br /><div style="text-align:center">
	<img src="../img/icon/check.png" /> The zone : <?php echo $_POST['service_zone_delete']; ?> has been correctly deleted </div><br />
	<br />
