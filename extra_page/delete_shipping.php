...
delete_shipping_one_by_one($_POST['service_delete']); 
?>		
	<br /><br /><div style="text-align:center">
	<img src="../img/icon/check.png" /> The most recent entries for the service : <?php echo $_POST['service_delete']; ?> has been correctly deleted </div><br />
	<br />
